...
<svelte:head>
  <style>
    :root {
      --hero-background: linear-gradient(transparent, rgba(0, 0, 0, 0.4)), url(/green-juice.jpeg);
...
<section>
  ...
  <div>
    <p>Duis quis erat fringilla, varius nisl ut, sodales velit. Donec ultricies interdum risus sed lobortis. Nulla sed porttitor velit. Quisque gravida lorem sit amet turpis bibendum cursus. Etiam ac elit nec diam gravida dignissim. Duis ac nibh arcu. Nunc fringilla enim vitae faucibus eleifend. Aliquam erat volutpat. Vestibulum varius neque et turpis bibendum, ac feugiat ante auctor. Integer blandit lectus ut enim pellentesque ullamcorper.</p>
  </div>
</section>
